...
export const FEATURED_ITEMS: NewsItem[] = [
  // ---- 2026-08-15 星期六 ----
  {
    ...
    date: "2026-08-15",
    time: "02:40",
    source: "Mirxes：Media Release（官网）",
    url: "https://www.mirxes.com/media-releases/mirxes-announces-nmpa-approval-for-gastroclear-in-china-paving-the-way-for-major-launch-in-key-market/",
    sourceType: "official",
    category: "regulatory",
    featured: true,
    score: 82,
    title: "觅瑞觅小卫®获 NMPA 批准：9,472 例前瞻注册临床支持",
    summary: [
      "Mirxes 官方公告披露，GASTROClear（觅小卫）获 NMPA 批准用于 45–74 岁胃癌高风险成人筛查；中国前瞻注册临床于 2021 年 12 月至 2023 年 11 月在 7 家临床机构入组 9,472 人。",
      "该产品成为中国首个获批用于胃癌筛查的无创血液检测；此前已在新加坡获批，并于 2023 年获得 FDA 突破性器械认定。",
    ],
    otherSources: 3,
    reason:"万人级前瞻注册研究与正式筛查适应证为单癌种血检申报提供了可参照路径；具体性能数字仍需以注册审评资料为准。",
    tags: ["觅瑞", "监管获批"],},{
    id: "f02b",
    date: "2026-08-15",
    time: "01:35",
    source: "Annals of Oncology（RSS）",
    url: "https://www.cell.com/the-innovation/fulltext/S2666-6758(25)00279-6",
    sourceType: "journal",
    ...
    tags: ["燃石医学", "文献"],},// ---- 2026-08-14 星期五 ----
  {
    ...
    url: "https://investors.guardanthealth.com/press-releases/press-releases/2025/Guardant-Health-Shield-Platform-Selected-for-Inclusion-in-National-Cancer-Institutes-Vanguard-Study-to-Evaluate-Emerging-Technologies-for-Multi-Cancer-Detection/default.aspx",
    sourceType: "official",
    category: "product",
    featured: true,
    score: 85,
    ...
    url: "https://www.exactsciences.com/news-events/press-releases/exact-sciences-launches-cancerguard-first-of-its-kind-multi-cancer-early-detection-blood-test",
    sourceType: "official",
    category: "product",
    featured: true,
    score: 78,
    ...
    time: "21:07",
    source: "JAMA（期刊）",
    url: "https://jamanetwork.com/journals/jama/fullarticle/2834891",
    sourceType: "journal",
    category: "publication",
    featured: true,
    score: 76,
    ...
    time: "19:31",
    source: "公众号：诺辉健康",
    url: "https://ir.newhorizonbio.com/",
    sourceType: "official",
    category: "funding",
    featured: true,
    score: 74,
    ...
    url: "https://aacrjournals.org/cancerdiscovery/article/14/11/2224/749197/Clinical-Validation-of-a-Cell-Free-DNA-Fragmentome",
    sourceType: "journal",
    category: "publication",
    featured: true,
    score: 72,
    ...
    url: "https://www.prnewswire.com/news-releases/singlera-genomics-receives-fda-breakthrough-device-designation-for-pdacatch-a-liquid-biopsy-assay-for-pancreatic-cancer-detection-in-high-risk-individuals-301817865.html",
    ...
    time: "11:20",
    source: "公众号：和瑞基因",
    url: "https://www.berrygenomics.com/cmscontent/180.html",
    sourceType: "official",
    category: "product",
    featured: true,
    score: 66,
    ...
    tags: ["和瑞基因", "产品发布"],},// ---- 2026-08-13 星期四 ----
  {
    ...
    time: "20:18",
    source: "公众号：燃石医学",
    url: "https://www.brbiotech.com/cn/news/details/4754",
    sourceType: "official",
    category: "regulatory",
    featured: true,
    score: 77,
    ...
    url: "https://doi.org/10.3390/cancers14194818",
    sourceType: "journal",
    category: "publication",
    featured: true,
    score: 71,
    ...
    time: "14:30",
    source: "公众号：泛生子",
    url: "https://www.genetronhealth.com/news_detail.html?id=772",
    sourceType: "official",
    category: "funding",
    featured: true,
    score: 63,
    ...
    time: "09:15",
    source: "早筛共识：专家评论",
    url: "https://www.cjco.cn/article/doi/10.12354/j.issn.1000-8179.2025.20250757",
    sourceType: "media",
    category: "opinion",
    featured: true,
    score: 68,
...
export const EXTRA_ITEMS: NewsItem[] = [
  {
    ...
    time: "20:14",
    source: "PubMed 监测",
    url: "https://pubmed.ncbi.nlm.nih.gov/?term=colorectal+cancer+screening+adherence+real-world&sort=date",
    sourceType: "journal",
    category: "publication",
    featured: false,
    score: 52,
    ...
    time: "18:40",
    source: "鹍远基因：官网新闻（网页）",
    url: "https://www.singlera.com.cn/news",
    sourceType: "official",
    category: "product",
    featured: false,
    score: 49,
    ...
    handle: "@DelfiDx",
    url: "https://delfidiagnostics.com/healthsystems/",
    sourceType: "social",
    category: "funding",
    featured: false,
    score: 47,
    ...
    time: "10:48",
    source: "SEC：EDGAR",
    url: "https://www.sec.gov/cgi-bin/browse-edgar?action=getcompany&CIK=0001576280&type=8-K",
    sourceType: "regulator",
    category: "funding",
    featured: false,
    score: 58,
    ...
    url: "https://clinicaltrials.gov/study/NCT01580540",
    sourceType: "regulator",
    category: "clinical",
    featured: false,
    score: 57,
