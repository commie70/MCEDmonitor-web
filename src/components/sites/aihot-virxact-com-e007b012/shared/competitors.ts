...
export interface Study {
  ...
  /** 更新时间：文献发表或会议届次 */
  updatedAt: string;
  /** 核验证据：信源库相对路径、Zotero 条目标识或公开网页 URL；分号分隔 */
  evidence?: string;
}
...
export function studyEvidenceHref({ companyId, studyIndex }: StudyEvidenceRef): string {
  return `/leaderboard/evidence/${companyId}/${studyIndex}`;
}
...
export const COMPETITORS: Competitor[] = [
  {
    ...
    cancers: ["肛门", "膀胱", "结直肠", "食管", "头颈", "肝", "胆管", "肺", "淋巴瘤", "卵巢", "胰腺", "浆细胞肿瘤", "胃"],
    cancerLabel: ">50 癌种(12 预设高致死类别；肝 / 胆管合并计 1 类)",
    mced: true,
    status: [
      { label: "FDA PMA 审评中(2026-01-29 提交)", tone: "cyan", scope: "MCED · 咨询会 2026-09-23" },{ label: "FDA 突破性器械(2018)", tone: "amber", scope: "MCED" },{ label: "LDT 商业化", tone: "muted", scope: "MCED" },],
    statusKeys: ["FDA突破性器械", "LDT商业化", "研发或申报中"],
    hasFDA: true,
    hasNMPA3: false,
    src: "Ann Oncol 2021(CCGA-3);Lancet 2023(PATHFINDER);Lancet Oncol 2023(SYMPLIFY);ASCO 2026(PATHFINDER 2 / NHS-Galleri);FDA / GRAIL 2026(PMA)",panel: "靶向甲基化：约 1,116,720 个 CpG、17.2 Mb 靶区，120-bp 探针，亚硫酸氢盐转化 + 杂交捕获测序",
    updatedAt: "2026-08(FDA 咨询会公告)",
    studies: [
      {
        ...
        evidence: "conference/2026 ASCO AACR/PATHFINDER2-17124_Giridhar_Slides.pptx;conference/2026 ASCO AACR/PATHFINDER_2_FactSheet.pdf;https://grail.com/press-releases/grail-announces-fda-advisory-committee-meeting-to-review-premarket-approval-application-for-the-galleri-multi-cancer-early-detection-test/",},{
        ...
        evidence: "conference/2026 ASCO AACR/NHS_Galleri-17101_Swanton_Slides.pptx;conference/2026 ASCO AACR/NHS_Galleri_Fact_Sheet.pdf",},{
        ...
        type: "前瞻队列",name: "SYMPLIFY(有症状疑癌转诊人群， Lancet Oncol 2023)",pop:"入组 6,238 例，5,461 例进入分析(英国 44 家医院)；初始 9 个月诊断 368 例癌，另有 24 个月注册随访",perf: "初始分析：特异性 98.4% / 灵敏度 66.3%(症状人群)，PPV 75.5%、NPV 97.6%，CSO top-1 85.2%，I 期 24.2%→IV 期 95.3%；24 个月随访将原 79 例假阳性中的 28 例重分类为癌，PPV 升至 84.2%",
        updatedAt: "2025-10(24 个月更新；原文 2023-06)",
        evidence: "Publication/1. Screening and diagnosis/美国 Grail/新建文件夹/2023.06 SYMPLIFY article.pdf;https://grail.com/press-releases/grail-and-university-of-oxford-present-long-term-data-from-the-symplify-study-evaluating-the-galleri-multi-cancer-early-detection-test-in-symptomatic-individuals-at-the-early-detection-of-cancer/",},{
    ...
    hasFDA: true,
    hasNMPA3: false,
    src: "Science 2018(CancerSEEK)/ 2020(DETECT-A);NEJM 2024(BLUE-C);AACR 2024(ASCEND-2);Exact Sciences 2025(Cancerguard 上市)",panel: "CancerSEEK：16 基因突变 + 8 蛋白；Cancerguard：DNA 甲基化 + 肿瘤相关蛋白；Cologuard Plus：多靶点粪便 DNA",
    updatedAt: "2025-09(Cancerguard LDT 上市)",
    studies: [
      {
        ...
        evidence: "Publication/papers/multiomics/CancerSEEK-cohen2018.pdf",},{
        type: "前瞻干预",name: "DETECT-A(Lennon 2020)",pop:"入组 10,006 名 65–75 岁、无癌史女性；9,911 人完成血液检测",perf: "确认血检特异性 98.9% / 灵敏度 27%；加 PET-CT 后特异性 99.6%、PPV 40.6%。原文未报告可直接用于横向比较的 I–II 期灵敏度",
        updatedAt: "2020-04(Science abb9601)",
        evidence: "Publication/papers/cohort/CancerSEEK2020_Detect-A-10.1126@science.abb9601.pdf",},{
        type: "病例对照",name: "Cancerguard 测试开发(2025 上市版资料)",pop:"开发研究覆盖 19 癌种；上市适用为 50–84 岁，且不适用于乳腺癌、前列腺癌筛查",perf: "特异性 97.4% / 总体灵敏度约 64%(不含乳腺、前列腺)；六大高致死癌灵敏度 68%；检出超过三分之一的 I–II 期癌",
        updatedAt: "2025-09(LDT 上市)",
        evidence: "https://www.exactsciences.com/news-events/press-releases/exact-sciences-launches-cancerguard-first-of-its-kind-multi-cancer-early-detection-blood-test;https://www.exactsciences.com/cancer-testing/cancerguard-mced-providers",},{
        type: "病例对照",name: "ASCEND-2(多中心前瞻采样病例对照；AACR 2024 poster LB100)",pop:">11,000 人前瞻采样，病例对照测试集 729 癌 / 2,434 非癌",perf: "甲基化 + 蛋白 OR-logic：特异性 98.5% / 灵敏度 50.9%(I 期 15.4%、II 期 38.0%、III 期 67.8%、IV 期 85.5%)；除乳腺 / 前列腺后 56.8%；六大侵袭性癌 63.7%。删除本地会议材料未支持的合并早期及逐癌种细分值",
    ...
    cancers: ["结直肠", "膀胱", "乳腺", "食管", "胃", "肝", "肺", "卵巢", "胰腺", "前列腺"],
    cancerLabel: "结直肠(获批)+ 10 癌种 MCD(膀胱 / 乳腺 / 结直肠 / 食管 / 胃 / 肝 / 肺 / 卵巢 / 胰腺 / 前列腺)",
    mced: true,
    status: [
    ...
    studies: [
      {
        ...
        type: "前瞻注册",name: "ECLIPSE(前瞻非随机， CRC;NEJM 2024)",pop:"45–84 岁平均风险、拟行筛查肠镜；共入组 22,877 人，临床验证队列 10,258 人，其中 7,861 人可评价",perf: "特异性 89.6%(进展期肿瘤口径)/ 灵敏度 83.1%(CRC；I–III 期 87.5%)，进展期癌前病变 13.2%。FDA SSED 口径：I 期 54.5%(12/22)。2024-07-26 获批(PMA P230009)",
        ...
        type: "病例对照",name: "Shield MCD(盲法病例对照， ASCO 2025 poster #10550)",pop:"盲法验证 n=814：癌 372 / 非癌 442；40–78 岁，中位 62 岁；此前训练集 >10,000 癌 + >7,000 对照不作为本行性能分母",perf: "特异性 98.6%(436/442)/ 灵敏度 60%(222/372，10 癌种；各癌种 21% 前列腺–96% 食管-胃；I/II 期 34%、III/IV 期 84%)；CSO top-1/2 93%；无现行筛查手段癌种 73%、六大侵袭性癌 74%",
        updatedAt: "2025-06(ASCO 2025)",
    ...
    cancerLabel: "结直肠",
    mced: false,
    status: [{ label: "FDA 获批(2026-07-27)", tone: "cyan", scope: "SimpleScreen CRC · ≥45 岁平均风险" }],
    statusKeys: ["FDA获批"],
    hasFDA: true,
    hasNMPA3: false,
    src: "JAMA 2025(PREEMPT CRC);Freenome / FDA 2026(SimpleScreen CRC 获批及更新版验证)",panel: "血浆 cfDNA 甲基化检测；Freenome 多组学平台另可整合蛋白与基因组特征",
    updatedAt: "2026-07(FDA 获批)",
    studies: [
      {
        type: "前瞻注册",name: "PREEMPT CRC(SimpleScreen CRC 获批依据；JAMA 2025 / FDA 2026)",pop:"45–85 岁无症状平均风险、拟行筛查肠镜；200 余中心；入组 48,995 人，JAMA 分析集 27,010 人",perf: "FDA 获批口径(按美国人口校正)：CRC 灵敏度 81.1%、进展期癌前病变 13.7%、高级别异型增生 30.5%，无进展期结直肠肿瘤特异性 90.4%。JAMA 未加权口径为 CRC 79.2%、进展期腺瘤 12.5%、特异性 91.5%",
        updatedAt: "2026-07(FDA 获批；原文 2025-06)",
        evidence: "conference/2025 ASCO + PREEMPT freenome/PREEMPT-jama_shaukat_2025_oi_250032_1748444687.1321.pdf;https://www.freenome.com/newsroom/fda-approves-freenomes-simplescreen-crc/",},{
        type: "前瞻注册",name: "PREEMPT CRC 更新版验证(2026 topline；拟补充 PMA)",pop:"PREEMPT CRC 盲法、既往未评价及既往评价样本；CRC 89 例、进展期癌前病变 1,570 例，其中高级别异型增生 157 例",perf: "按美国人口校正：CRC 灵敏度 80.4%(I 期 52.0%、II 期 100%、III 期 97.3%、IV 期 100%)；进展期癌前病变 18.2%，高级别异型增生 41.9%；肠镜无异常者特异性 90.0%。该版本尚拟提交补充 PMA，不等同于 2026-07 已批准版本",
        updatedAt: "2026-07-09(公司 topline)",
        evidence: "https://www.freenome.com/newsroom/freenome-reports-top-line-readout-of-updated-simplescreen-crc-colorectal-cancer-screening-blood-test-met-all-primary-and-secondary-endpoints/",},],},{
    id: "delfi",
    ...
    hasFDA: false,
    hasNMPA3: false,
    src: "Nature 2019(Cristiano 多癌种);Cancer Discov 2024(DELFI-L101,PMID 38829053)",panel: "低深度 WGS 片段组学(5 Mb 非重叠窗口，短 / 长片段比 + CNV)",
    ...
    studies: [
      {
        ...
        evidence: "Publication/papers/cohort/Clinical validation of a ctDNA-Based Assay for Multi-Cancer Detection  An Interim Report from a Vietnamese Longitudinal Prospective Cohort Study of 27越南早筛前瞻干预.pdf",},{
        type: "前瞻干预",name: "K-DETEK(Nguyen 2025；综述统一口径)",pop:"≥40 岁无症状人群，前瞻性单臂干预研究；n=10,027",perf: "特异性 99.71% / 灵敏度 70.83%(I–IIIA 期 70.59%)；TOO top-2 52.94%",
        updatedAt: "2025-02(BMC Med 23:90)",
        evidence: "Publication/Evidence/多癌种筛查专家共识2025/1-s2.0-S2095927325006565-main.pdf",},],},];
...
export const COMPETITORS_CN: Competitor[] = [
  {
    ...
    hasFDA: true,
    hasNMPA3: false,
    src: "Nature Medicine 2025(DECIPHE-Omnia);AACR 2024(#1266/#1263)；金陵队列 NCT06011694",panel: "低深度 WGS(MERCURY，整合基因组与片段组特征：片段长度、CNV、末端 motif、推断甲基化及基因表达指标)",
    updatedAt: "2025-06(Nat Med)",
    studies: [
      {
        type: "病例对照",name: "DECIPHE-Omnia 独立验证(Nat Med 2025)",pop:"独立验证：677 癌 / 687 非癌；13 癌种。开发与内部验证另纳入 6,391 人",perf: "标准特异性阈值：特异性 97.8% / 灵敏度 87.4%；TOO top-1 82.4%、top-2 91.7%。删除原看板未由正文直接支持的分期近似值",
        updatedAt: "2025-06(Nat Med)",
        evidence: "zotero:TRW2GRKF/Bao 等 - 2025 - Early detection of multiple cancer types using multidimensional cell-free DNA fragmentomics.pdf;conference/2024 AACR study_highlight/2024 AACR early screening study share_v4.2.pptx",},{
        type: "前瞻队列",name: "金陵队列(NCT06011694；Nat Med 2025)",pop:"45–75 岁无症状人群；首年中期分析可评价 n=3,724，确认癌 43 例",perf: "标准特异性阈值：特异性 98.1%(3,612/3,681) / 灵敏度 53.5%(23/43)；PPV 25.0%、NPV 99.4%；stage 0/I 期 44.8%(13/29)、II 期 85.7%(6/7)。43 例中 93.0%(40/43)为高危癌前病变或 0/I/II 期；该 93.0% 是病例分期构成，不是早期灵敏度",
        updatedAt: "2025-06(Nat Med)",
        evidence: "zotero:TRW2GRKF/Bao 等 - 2025 - Early detection of multiple cancer types using multidimensional cell-free DNA fragmentomics.pdf;conference/2024 AACR study_highlight/2024 AACR early screening study share_v4.2.pptx",},],},{
    id: "burningrock",
    co: "燃石医学",
    ...
    hasFDA: true,
    hasNMPA3: false,
    src: "Nature Communications 2020(泰州队列 TZL);BMC Medicine 2022(PDACatch);Mol Cancer 2025(GUIDE/GutSeer)",panel: "PanSeer：半靶向 PCR 检测 595 个基因组区域、11,787 个 CpG 位点，分析 LoD 0.1%；PDACatch：胰腺癌甲基化 panel；GUIDE：甲基化 + 片段组学",
    ...
    studies: [
      {
        ...
        evidence: "conference/2025 ASCO + PREEMPT freenome/鹍远-GUIDE a prospective cohort study for blood-based early detection of gastrointestinal cancers using targeted DNA methylation and fragmentomics sequencing.pdf",},{
    ...
    hasFDA: false,
    hasNMPA3: true,
    src: "MedComm 2023(Clear-C 论文， Hu et al.);CSCO 2020(会议口径)；人民日报；JPM2024 公司 deck",panel: "FIT-sDNA(qPCR)：KRAS 突变 + BMP3/NDRG4 甲基化 + 粪便血红蛋白",
    ...
    hasFDA: true,
    hasNMPA3: false,
    src: "PNAS 2019(先导);HIT 研究 2021(多中心前瞻终分析);Sci Transl Med 2022",panel: "Mutation Capsule：外周血 cfDNA 多重甲基化 + 突变信号；HCCscreen 同时结合血清蛋白标志物",
    updatedAt: "2021-03(HIT 终分析)",
    studies: [
      {
        type: "前瞻队列",name: "HIT 多中心前瞻终分析",pop:"1,615 名完成随访的 HBsAg+ 人群；HCC 86 / 非 HCC 1,529",perf: "特异性 93%(1,419/1,529) / 灵敏度 88%(76/86)，PPV 40.9%、NPV 99.3%；按肿瘤大小：<3 cm 85%(28/33)、3–5 cm 96%(22/23)、>5 cm 88%(7/8)。单癌种无 TOO",
        updatedAt: "2021-03-24(终分析公开)",
        evidence: "https://www.biospace.com/genetron-health-releases-new-data-results-of-hccscreen-for-liver-cancer-early-screening-in-china;conference/2022 ASCO/前瞻性研究list.xlsx",},{
    ...
    hasFDA: true,
    hasNMPA3: false,
    src: "UriFind(Clin Epigenetics 2021;13:91——基线误作 BMC Med，已纠偏);PulmoSeek(JCI 2021);PulmoSeek Plus(Lancet Digit Health 2023);FDA 突破性器械",panel: "UriFind：尿液 DNA PCR 甲基化检测，双标志物 ONECUT2/VIM 用于检出，五标志物 VIM/OSTM1/SLC4A10/AC092805.1/ONECUT2 用于风险分层；PulmoSeek：血浆 cfDNA 甲基化肺结节分类",
...
export const PROSPECTIVE: ProspectiveRow[] = [
  {
    ...
    evidenceRef: { companyId: "grail", studyIndex: 2 }, updatedAt: "2026-06(ASCO)",},{
    co: "Exact Sciences",prod: "CancerSEEK(前身)", route: ["突变", "蛋白质"],
    type: "前瞻干预", study: "DETECT-A(Lennon 2020)", mced: true, canc: "多癌种",pop:"入组 10,006 名 65–75 岁无癌史女性；9,911 人完成血液检测",
    spec: "98.9%", specSub: "+PET-CT 99.6%", sens: "27%",
    early: "—", earlySub: "原文未报告可直接横比的早期灵敏度", too: "—", tooSub: "加 PET-CT 后 PPV 40.6%",
    evidenceRef: { companyId: "exact", studyIndex: 1 }, updatedAt: "2020-04(Science)",},{
    co: "GRAIL",prod: "Galleri®", route: ["甲基化"],
    ...
    evidenceRef: { companyId: "grail", studyIndex: 1 }, updatedAt: "2026-06(ASCO)",},{
    co: "Guardant Health",prod: "Shield™", route: ["甲基化", "片段组学"],
    type: "前瞻注册", study: "ECLIPSE(NEJM 2024)", mced: false, canc: "结直肠",pop:"45–84 岁平均风险、拟行筛查肠镜；总入组 22,877，验证队列 10,258，可评价 n=7,861",
    ...
    evidenceRef: { companyId: "guardant", studyIndex: 1 }, updatedAt: "2024-03(NEJM)",},{
    co: "Freenome",prod: "SimpleScreen CRC", route: ["甲基化"],
    type: "前瞻注册", study: "PREEMPT CRC(SimpleScreen CRC 获批依据)", mced: false, canc: "结直肠",pop:"45–85 岁无症状平均风险、拟行筛查肠镜；48,995 入组，JAMA 分析集 n=27,010",
    spec: "90.4%", specSub: "FDA 人口校正口径；JAMA 未加权 91.5%", sens: "81.1%", sensSub: "FDA 人口校正口径；JAMA 未加权 79.2%",
    early: "13.7%", earlySub: "进展期癌前病变；高级别异型增生 30.5%", too: "—",
    evidenceRef: { companyId: "freenome", studyIndex: 0 }, updatedAt: "2026-07(FDA 获批)",},{
    co: "Freenome",prod: "SimpleScreen CRC 更新版", route: ["甲基化"],
    type: "前瞻注册", study: "PREEMPT CRC 更新版验证(拟补充 PMA)", mced: false, canc: "结直肠",pop:"盲法 PREEMPT CRC 样本；CRC 89、进展期癌前病变 1,570、高级别异型增生 157",
    spec: "90.0%", specSub: "肠镜无异常者；人口校正", sens: "80.4%", sensSub: "CRC；I 期 52.0%、II 期 100%",
    early: "18.2%", earlySub: "进展期癌前病变；高级别异型增生 41.9%", too: "—", tooSub: "尚未等同于已批准版本",
    evidenceRef: { companyId: "freenome", studyIndex: 1 }, updatedAt: "2026-07(topline)",},{
    ...
    evidenceRef: { companyId: "exact", studyIndex: 5 }, updatedAt: "2024-03(NEJM)",},{
    ...
    evidenceRef: { companyId: "exact", studyIndex: 4 }, updatedAt: "2014(NEJM)",},{
    ...
    evidenceRef: { companyId: "newhorizon", studyIndex: 0 }, updatedAt: "2023-07(MedComm)",},{
    co: "觅瑞 Mirxes",prod: "觅小卫®", route: ["miRNA"],
    ...
    evidenceRef: { companyId: "grail", studyIndex: 5 }, updatedAt: "2023-10(Lancet)",},{
    co: "Geneoscopy",prod: "ColoSense™", route: ["RNA", "FIT"],
    ...
    evidenceRef: { companyId: "geneoscopy", studyIndex: 0 }, updatedAt: "2023-10(JAMA)",},{
    co: "泛生子",prod: "HCCscreen™", route: ["多组学"],
    type: "前瞻队列", study: "HIT 多中心前瞻终分析", mced: false, canc: "肝",pop:"1,615 名完成随访的 HBsAg+ 人群；HCC 86 / 非 HCC 1,529",
    spec: "93%", sens: "88%", sensSub: "HCC",
    early: "85–96%", earlySub: "<3cm 85%、3–5cm 96%",
    too: "—", tooSub: "PPV 40.9% / NPV 99.3%",
    evidenceRef: { companyId: "genetron", studyIndex: 0 }, updatedAt: "2021-03(终分析)",},{
    co: "Gene Solutions",prod: "SPOT-MAS™", route: ["多组学"],
    type: "前瞻干预", study: "K-DETEK(Nguyen 2025；综述统一口径)", mced: true, canc: "5 癌种",pop:"≥40 岁无症状人群，前瞻性单臂干预研究；n=10,027",
    spec: "99.71%", sens: "70.83%", sensSub: "覆盖 11 癌种(含 6 种无标准筛查)",
    early: "70.59%", earlySub: "早期 I–IIIA",
    too: "52.94%", tooSub: "top-2；仅保留综述表支持的字段",
    evidenceRef: { companyId: "genesolutions", studyIndex: 2 }, updatedAt: "2025-02(综述表)",},{
    ...
    spec: "98.1%", specSub: "3,612/3,681", sens: "53.5%", sensSub: "23/43；标准特异性阈值",
    early: "44.8%", earlySub: "stage 0/I 期 13/29；II 期 85.7%(6/7)。93.0% 是病例分期构成，非灵敏度",
    too: "—", tooSub: "前瞻队列未单独报告 TOO；病例对照 top-1 82.4%",
    evidenceRef: { companyId: "geneseeq", studyIndex: 1 }, updatedAt: "2025-06(Nat Med)",},{
    co: "GRAIL",prod: "Galleri", route: ["甲基化"],
    type: "前瞻队列", study: "SYMPLIFY(有症状疑癌转诊)", mced: true, canc: ">50 癌种",pop:"入组 6,238；5,461 例进入分析(44 家医院)，9 个月诊断 368 例癌",
    spec: "98.4%", sens: "66.3%", sensSub: "症状人群、个体水平",
    early: "—", earlySub: "I 期 24.2% → IV 期 95.3%",
    too: "85.2%", tooSub: "top-1 CSO;PPV 75.5%(2 年随访重分类后 84.2%)",
    evidenceRef: { companyId: "grail", studyIndex: 4 }, updatedAt: "2025-10(24 个月更新)",},];
